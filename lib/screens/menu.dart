...
import 'package:luluorange_mobile/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
  MyHomePage({super.key});
  final String nama = "Rasyad Zulham"; //nama
  final String npm = "2406348540"; //npm
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Luluorange" dengan teks putih dan tebal.
        title: const Text(
          'Luluorange',
          style: TextStyle(
            color: Colors.white,
